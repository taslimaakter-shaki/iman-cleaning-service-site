  ...
  <div class="ds-shell">
    ...
    <div class="footer-grid">
      ...
      <div class="footer-cell">
        ...
        <h4>Service area</h4>
        <p><a href="./areas.html">Manhattan, Brooklyn, Queens, The Bronx, Staten Island, and Long Island</a></p>
      </div>
      <div class="footer-cell">
      ...
      <div class="footer-cell">
        ...
        <p>8 AM – 8 PM · 7 days</p>
      </div>
    </div>
    <div class="footer-service-base">
      <h4>Based in Queens, New York</h4>
      <p>Serving Queens, New York City, and select Long Island communities</p>
      <p><a href="tel:+19298034053">929-803-4053</a> · Open daily, 8 AM–8 PM</p>
    </div>
